...
**Faz 8 — Pilot/Demo** (devam ediyor) — Iter 8.1 (demo orkestrasyon: launcher + senaryolar + runbook) ✅ DONE (2026-06-03); **Iter 8.2 (dashboard görsel zenginleştirme: KPI + filo sağlık kartları + Altair anomali overlay + açık kurumsal tema + cihaz-özeti uyarı akışı) ✅ DONE (2026-06-14).** Faz 1-5 + Faz 7 ✅ DONE. **Faz 6 — ML dedektörler (Isolation Forest) ATLANDI / Faz 9+ stretch'e ertelendi** (kullanıcı kararı 2026-06-03: simülatör yalnız A/B/C üretiyor, ikisi de mevcut iki katmanca yakalanıyor → ML'in sentetik veride marjinal tespit değeri düşük + en yüksek karmaşıklık).
